...
window.title('一阶RC零输入响应')
window.geometry('1000x1000')

# 等效电压的输入
label_u = tk.Label(window, text='初始电压:', font=('Arial', 10), width=15, height=1)
...
class From1:
    ...
    def create_matplotlib(self, U, Req, C):
        ...
        uc = float(U) * np.exp(-1.0 / float(tal) * t)
        plt.plot(t, uc)
        ...
        plt.title(r"RC Zero Input Response", fontproperties='SimHei', fontsize=20)
