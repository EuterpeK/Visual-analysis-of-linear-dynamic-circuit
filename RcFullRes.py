...
class From1:
    ...
    def create_matplotlib(self, Us, Req, U0, C):  # 电源电压 等效电阻 电容初始电压 电容
        ...
        plt.title(r"RC Full Response", fontproperties='SimHei', fontsize=20)

        plt.grid(True)
        # plt.axis([0, 100.0, 0, float(Us)])
        plt.show()
...
class From2:
    ...
    def create_matplotlib(self, Us, U0, v):
        # 创建绘图对象f
        f = plt.figure(num=2, figsize=(8, 8), dpi=80, facecolor="pink", edgecolor='green', frameon=True)
        # 创建一副子图
        tal = v
