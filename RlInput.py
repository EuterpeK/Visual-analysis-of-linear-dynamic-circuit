...
# 等效电压的输入
label_i = tk.Label(window, text='初始电流:', font=('Arial', 10), width=15, height=1)
...
class From1:
    ...
    def create_matplotlib(self, I, Req, L):
        ...
        plt.title(r"RL Zero State Response", fontproperties='SimHei', fontsize=20)
...
class From2:
    ...
    def create_matplotlib(self, I, v):
        # 创建绘图对象f
        f = plt.figure(num=2, figsize=(8, 8), dpi=80, facecolor="pink", edgecolor='green', frameon=True)
        # 创建一副子图
        tal = v
        ...
        plt.xlabel("时间t/s", fontproperties='SimHei', fontsize=15, color='red')
        plt.ylabel("电流Li/A", fontproperties='SimHei', fontsize=15, color='red')
        plt.title(r"RL Zero Input Response", fontproperties='SimHei', fontsize=20)
